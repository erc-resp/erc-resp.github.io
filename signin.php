...
<html lang="en">
  ...
  <body class="text-center">
    <footer class="page-footer font-small black pt-4" id="loginheader">

      <div class="container-fluid text-center text-md-left" id="loginheader">
